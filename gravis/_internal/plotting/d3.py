...
def d3(data,
    ...
    _ca(use_collision_force, 'use_collision_force', bool)
    _ca(collision_force_radius, 'collision_force_radius', (int, float))
    _ca(collision_force_strength, 'collision_force_strength', (int, float))
    ...
    insert_data = {
        ...
        'USE_COLLISION_FORCE': _ts.to_json(use_collision_force),
        'COLLISION_FORCE_RADIUS': _ts.to_json(collision_force_radius),
        'COLLISION_FORCE_STRENGTH': _ts.to_json(collision_force_strength),
